      ...
      <nav className="flex flex-row justify-between items-center py-6 px-6">
        <div className="flex gap-12 items-center">
          ...
          <ul className="space-x-4 text-gray-400 text-base hidden lg:block">
            <li>
              <Link href="#about">
                <a className="text-gray-400 hover:text-blue-600">About</a>
              </Link>
            </li>
            <li>
              <Link href="#features">
                <a className="text-gray-400 hover:text-blue-600">Features</a>
              </Link>
            </li>
            <li>
              <Link href="#works">
                <a className="text-gray-400 hover:text-blue-600">How it Works</a>
              </Link>
            </li>
            <li>
              <Link href="#contact">
                <a className="text-gray-400 hover:text-blue-600">Contact</a>
              </Link>
            </li>
          </ul>
        </div>
