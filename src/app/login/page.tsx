...
export default function LoginPage() {
	...
	return (
		<Linelayout>
			...
			>
				...
				<Button
					type="submit"
					className="md:w-[200px] lg:w-[336px] bg-blue-600 text-base text-white"
				>
					Log into Account
				</Button>
				<div>
	...
	//             rightIcons={<Mail className="h-5 w-5 text-muted-foreground text-gray-600" />}
	//           />
	//         </div>
	...
	//             onClick={onToggle}
	//             className="w-full rounded bg-background"
	//             rightIcons={isToggle ?  <EyeOff  className="h-5 w-5 text-muted-foreground text-gray-600 cursor-pointer" /> : <Eye className="h-5 w-5 text-muted-foreground text-gray-600 cursor-pointer"/>}
	//           />
	//         </div>
	//         <div className="flex items-center gap-8">
	//           <div className=" space-x-1">
